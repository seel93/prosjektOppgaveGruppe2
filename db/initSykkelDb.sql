...
-- ma. 02. april 2018 kl. 16.59 +0200
...
CREATE TABLE IF NOT EXISTS `AS_SykkelUtleie`.`bestilling` (
  ...
  INDEX `fk_bestilling_Utstyr1_idx` (`Utstyr_utstyr_id` ASC),
  ...
  CONSTRAINT `fk_bestilling_ansatt1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bestilling_Utstyr1`
